...
if is_file_exists(img1_pth) != True:
    print("Image 1 did not exists or is not an image...")
    sys.exit()
elif is_file_exists(img2_pth) != True:
    print("Image 2 did not exists or is not an image...")
    sys.exit()
else:
    print("Image File Successfully Verfied...")
...
print("Sucessfully processed face features on Image 1...")
print("Processing face features on Image 1...")
...
print("Sucessfully detect and crop face on Image 1...")
print("Detecting and cropping face on Image 2...")
img2_base64 = detect_and_crop_face(img2_pth)
print("Sucessfully detect and crop face on Image 2...\n")

print("Calculating face emmbeddings on Image 1...")
img1_embeddings = face_embeddings_extract(img1_pth)
print("Sucessfully calculated face emmbeddings on Image 1...")
print("Calculating face emmbeddings on Image 2...")
img2_embeddings = face_embeddings_extract(img2_pth)
print("Sucessfully calculated face emmbeddings on Image 2...\n")

print("Detecting face contour on Image 1...")
face_contoured1 = draw_skin_contour(img1_base64)
print("Successfully detecting face contour on Image 1...")
...
print("Successfully generated face comparison report [face_comparison_report - " + str(reportid) + ".html]")
